...
SUBCOMMANDS = ["lint", "check", "audit", "publish", "show", "demote",
               "featured", "push", "schedule", "pending", "slots", "queue", "ids", "overdue", "unschedule", "trash", "reserve", "render", "timezone", "ig"]
FUNCTIONS = ["parse", "visible_chars", "headings", "sections", "lint", "api",
             ...
             "site_timezone", "trash", "queue", "all_ids", "ids", "overdue", "taken_slots", "next_free_slot", "slots", "render", "timezone_set",
             "title_halves", "lead", "key_sentence", "carousel", "ig", "ig_pending"]
